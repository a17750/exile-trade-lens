    ...
    function create(dataset, englishById = new Map()) {
        ...
        function matchingRenderings(statId, original) {
            ...
            if (!Array.isArray(renderings))
                return [];
            return renderings.filter((rendering) => rendering?.text && sameShape(rendering.english, original));
        }
